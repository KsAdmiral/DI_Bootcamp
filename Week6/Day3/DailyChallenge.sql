...
-- display all customers' first_name and isLoggedIn columns
SELECT Customer.first_name, COALESCE(Customer_profile.isLoggedIn, false)
FROM Customer 
...
-- Because of ON DELETE CASCADE the reference that student in the Library table are also deleted 
